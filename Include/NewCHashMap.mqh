...
#include <Generic/HashSet.mqh> // Changed from "HashSet.mqh"
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::CHashMap(void): m_count(0),
                          m_free_list(0),
                          m_free_count(0),
                          m_capacity(0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::CHashMap(const int capacity): m_count(0),
                                        m_free_list(0),
                                        m_free_count(0),
                                        m_capacity(0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::CHashMap(IEqualityComparer<TKey>*comparer): m_count(0),
                                                      m_free_list(0),
                                                      m_free_count(0),
                                                      m_capacity(0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::CHashMap(const int capacity,IEqualityComparer<TKey>*comparer): m_count(0),
                                                                         m_free_list(0),
                                                                         m_free_count(0),
                                                                         m_capacity(0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::CHashMap(IMap<TKey,TValue>*map): m_count(0),
                                           m_free_list(0),
                                           m_free_count(0),
                                           m_capacity(0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::CHashMap(IMap<TKey,TValue>*map,IEqualityComparer<TKey>*comparer): m_count(0),
                                                                            m_free_list(0),
                                                                            m_free_count(0),
                                                                            m_capacity(0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
CHashMap<TKey,TValue>::~CHashMap(void)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Add(CKeyValuePair<TKey,TValue>*pair)
  {
//--- check pair
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Add(TKey key,TValue value)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Contains(CKeyValuePair<TKey,TValue>*item)
  {
//--- check pair
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Contains(TKey key,TValue value)
  {
//--- find pair with specified key
   int i=FindEntry(key);
//--- create default equality value comparer
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::ContainsKey(TKey key)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::ContainsValue(TValue value)
  {
//--- create default equality value comparer
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
int CHashMap<TKey,TValue>::CopyTo(CKeyValuePair<TKey,TValue>*&dst_array[],const int dst_start=0)
  {
//--- resize array
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
int CHashMap<TKey,TValue>::CopyTo(TKey &dst_keys[],TValue &dst_values[],const int dst_start=0)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
void CHashMap<TKey,TValue>::Clear(void)
  {
//--- check count
   if(m_count>0)
     {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Remove(CKeyValuePair<TKey,TValue>*item)
  {
//--- check pair
   if(CheckPointer(item)==POINTER_INVALID)
      return(false);
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Remove(TKey key)
  {
   if(m_capacity!=0)
     {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::TryGetValue(TKey key,TValue &value)
  {
//--- find pair with specified key
   int i=FindEntry(key);
//--- check index
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::TrySetValue(TKey key,TValue value)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
void CHashMap<TKey,TValue>::Initialize(const int capacity)
  {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Resize(const int new_size)
  {
//--- resize buckets
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
int CHashMap<TKey,TValue>::FindEntry(TKey key)
  {
   if(m_capacity!=NULL) // This was m_capacity!=0 in my previous interpretation, standard uses NULL check for pointers. For int, !=0 is fine.
     {
...
//+------------------------------------------------------------------+
template<typename TKey,typename TValue>
bool CHashMap<TKey,TValue>::Insert(TKey key,TValue value,const bool add)
  {
   if(m_capacity==0)
      Initialize(0);
//--- get hash code from key
...
template<typename TKey,typename TValue>
/*static*/ int CHashMap<TKey,TValue>::m_collision_threshold=8; // Standard is 100, but file has 8. Keeping file's value.
//+------------------------------------------------------------------+